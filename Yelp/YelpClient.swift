...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: NSNumber?, limit: Int?, offset: Int?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        ...
        if distance != nil {
            ...
            let distanceMeters = metersPerMile * distance!.doubleValue
            parameters["radius_filter"] = distanceMeters as AnyObject // Convert to meters
        }
